...
#poverty variables for all US counties in 2012. Data is exported to a CSV file 
#to be used with the accompanying analyze file. 
...
attain.to_csv('census/census-povstat-12.csv')
